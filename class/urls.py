...
from .views import (
    ...
    assign_facilitator, admin_sessions_filter, set_session_day,
)
...
urlpatterns = [
    ...
    path("supervisor/class/set-active-day/", set_active_day, name="set_active_day"),
...
path(
    ...
    path("api/set-session-day/", set_session_day, name="set_session_day"),
